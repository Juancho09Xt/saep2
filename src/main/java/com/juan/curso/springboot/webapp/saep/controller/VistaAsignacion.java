...
public class VistaAsignacion {
    ...
    public String listar(Model model) {
        ...
        return "asignaciones"; // asignacion.html
    }
    ...
    public String formulario(Model model, @RequestParam(required = false) Long id) {
        Asignacion asignacion = (id != null) ?
                asignacionesRepository.findById(id).orElse(new Asignacion()) :
                new Asignacion();
    ...
    @PostMapping("/guardar")
    public String guardar(@ModelAttribute Asignacion asignacion, RedirectAttributes ra) {
